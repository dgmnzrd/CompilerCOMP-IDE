...
"-" {Numero} { return token(yytext(), "NUMERO_NEGATIVO", yyline, yycolumn); }
"-" {Numero} "." {Numero} { return token(yytext(), "REAL_NEGATIVO", yyline, yycolumn); }
...
"POW" | "pow" | "Pow" { return token(yytext(), "POWER", yyline, yycolumn); }
...
"-" {Identificador} { return token(yytext(), "OPERACION_ID", yyline, yycolumn); }
